...
/* package my-calculator-0.1.0.0 */
#ifndef VERSION_my_calculator
#define VERSION_my_calculator "0.1.0.0"
#endif /* VERSION_my_calculator */
#ifndef MIN_VERSION_my_calculator
#define MIN_VERSION_my_calculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_calculator */
...
#define CURRENT_COMPONENT_ID "my-calculator-0.1.0.0-5oqkYf6AvlY8NfCBndNZve-my-calculator"
